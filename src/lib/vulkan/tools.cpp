...
#undef STR
            ...
            VkViewport initializers::viewport(
                    float width, 
                    float height, 
                    float minDepth, 
                    float maxDepth)
            ...
            VkDescriptorPoolCreateInfo initializers::descriptorPoolCreateInfo(
            ...
            VkDescriptorSetLayoutBinding initializers::descriptorSetLayoutBinding(
                    VkDescriptorType type, 
            ...
            VkDescriptorSetAllocateInfo initializers::descriptorSetAllocateInfo(
            ...
            VkWriteDescriptorSet initializers::writeDescriptorSet(
            ...
            VkVertexInputBindingDescription initializers::vertexInputBindingDescription(
                    uint32_t binding, 
                    uint32_t stride, 
            ...
            VkVertexInputAttributeDescription initializers::vertexInputAttributeDescription(
                    uint32_t binding, 
                    uint32_t location, 
                    VkFormat format, 
                    uint32_t offset)
            ...
            VkPipelineColorBlendAttachmentState initializers::pipelineColorBlendAttachmentState(
            ...
            VkComputePipelineCreateInfo initializers::computePipelineCreateInfo(VkPipelineLayout layout, VkPipelineCreateFlags flags)
            {
            ...
            VkPushConstantRange initializers::pushConstantRange(
                    VkShaderStageFlags stageFlags,
                    uint32_t size,
                    uint32_t offset)
            {
