...
// Node
SceneGraphNode::SceneGraphNode(int _uid, int _node, QQuickItem* parent) : QQuickPaintedItem(parent), m_uid(_uid), m_node(_node)
{
...
{
    m_nodes.push_back(new SceneGraphNode(0,320));
